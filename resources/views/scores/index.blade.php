    ...
    <div class="px-5">
        ...
        <div class="justify-center w-9/12 mx-auto mt-8 rounded-lg">
            ...
            <div class="flex space-x-4">
                <Link href="{{ route('score.create') }}" class="" modal>
        ...
        <div class="grid justify-center w-9/12 grid-cols-1 gap-4 mx-auto mt-8 md:grid-cols-2 lg:grid-cols-3">
            @foreach ($scores as $song)
                <div class="p-4 border border-gray-300 rounded-lg">
                    <p class="mb-2 text-xl font-bold text-gray-700 leadinlg-none">Title: {{ $song->test }}</p>
                    <p class="mb-2 text-base font-medium leading-none text-gray-700">Mark: {{ $song->score }}</p>
                </div>
            @endforeach
        </div>
    </div>
